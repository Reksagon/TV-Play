...
class FavoriteContainerFragment :
    ...
    override fun onViewBindingCreated(binding: FragmentFavoriteContainerBinding) {
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        tvViewModel.selectCategory(Category(0, getString(R.string.player_menu_item_favorite)))
    }
